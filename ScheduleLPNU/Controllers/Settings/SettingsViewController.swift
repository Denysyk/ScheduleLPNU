...
class AboutAppViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        **Версія 2.0**
        * Кастомізований таб-бар: Повністю оновлена, інтуїтивно зрозуміла та стильна навігація.
        * Інтеграція з системним календарем: Додайте будь-яке заняття прямо у ваш системний календар.
        * Темна тема (Dark Mode): Комфортний перегляд розкладу вночі та при слабкому освітленні.

        **Версія 1.0**
        * Початковий випуск (Реліз)
        """
