//
//  PhdStudentScheduleViewController.swift
//  ScheduleLPNU
//
...
class PhdStudentScheduleViewController: BaseFullScreenViewController {
    ...
    private func setupCustomTitleView() {
        let title = "РОЗКЛАД ЗАНЯТЬ ДЛЯ АСПІРАНТІВ"
    ...
    private func navigateToResults() {
        // Якщо у вас є segue:
        // performSegue(withIdentifier: "showPhdResult", sender: self)
        
        // Або програмна навігація:
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        if let resultVC = storyboard.instantiateViewController(withIdentifier: "ResultPhdScheduleViewController") as? ResultPhdScheduleViewController {
