...
class ExternalStudentScheduleViewController: BaseFullScreenViewController, UITextFieldDelegate {
    ...
    private func navigateToResults() {
        // Якщо у вас є segue:
        // performSegue(withIdentifier: "showExternalScheduleResult", sender: self)
