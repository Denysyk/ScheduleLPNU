...
class ResultPhdScheduleViewController: BaseFullScreenViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private func setupCustomNavigationTitle() {
        let fullTitle = "Аспірантура \(groupName)"
    ...
    private func loadScheduleData() {
        ...
        // URL для розкладу аспірантів
        let baseURL = "https://student.lpnu.ua/postgraduate_schedule"
        ...
        do {
            ...
            if let noDataMessage = try? viewContent.select(".view-empty").first()?.text(),
               !noDataMessage.isEmpty {
                showAlert(title: "Інформація", message: "Розклад для аспірантів не знайдено для групи \(groupName)")
                return
            }
                       
            // Для аспірантів використовуємо стандартну структуру
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Використовуємо звичайний метод для аспірантів
