//
//  StudentExamScheduleViewController.swift
//  ScheduleLPNU
//
...
class StudentExamScheduleViewController: BaseFullScreenViewController {
    ...
    private func navigateToResults() {
        // Якщо у вас є segue:
        // performSegue(withIdentifier: "showStudentExamResult", sender: self)
        
        // Або програмна навігація:
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        if let resultVC = storyboard.instantiateViewController(withIdentifier: "ResultStudentExamScheduleViewController") as? ResultStudentExamScheduleViewController {
