...
class ExternalPhdStudentScheduleViewController: UIViewController {
    ...
    private func navigateToResults() {
        ...
        if let resultVC = storyboard.instantiateViewController(withIdentifier: "ResultExternalPhdStudentScheduleViewController") as? ResultExternalPhdStudentScheduleViewController {
